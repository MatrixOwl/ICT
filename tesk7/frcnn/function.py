...
def rpn_layer(base_layers, num_anchors):
    ...
    Returns:
        ...
        base_layers: vgg in here
    """
    x = Conv2D(128, (3, 3), padding='same', activation='relu', kernel_initializer='normal', name='rpn_conv1')(
        base_layers)
...
def calc_rpn(C, img_data, width, height, resized_width, resized_height, img_length_calc_function):
    ...
    Args:
        ...
        img_length_calc_function: function to calculate final layer's feature map (of base model) size according to
        input image size
                ...
                for jy in range(output_height):
                    ...
                    for bbox_num in range(num_bboxes):
                        ...
                        if img_data['bboxes'][bbox_num]['class'] != 'bg':
                            ...
                            # all GT boxes should be mapped to an anchor box, so we keep track of which anchor bo
                            # x was best
                            ...
                            # we set the anchor to positive if the IOU is >0.7 (it does not matter if there was anot
                            # her better box, it just indicates overlap)
...
def rpn_loss_cls(num_anchors):
    ...
    Args:
        num_anchors: number of anchors (9 in here)
        y_true[:, :, :, :9]: [0,1,0,0,0,0,0,1,0] means only the second and the eighth box is valid which contains pos
        or neg anchor => isValid
...
def non_max_suppression_fast(boxes, probs, overlap_thresh=0.7, max_boxes=300):
    ...
    #   Step 3: Calculate the IoU with 'Last' box and other boxes in the list. If the IoU is larger than overlap
    #
